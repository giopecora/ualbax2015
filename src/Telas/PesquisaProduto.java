...
public class PesquisaProduto extends javax.swing.JFrame {
    ...
    private TelaMovimentacao telaAnterior;
    public PesquisaProduto() {
        initComponents();
    }
     PesquisaProduto(TelaMovimentacao telaAnterior) {
        this();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            try {
                rs = dao.pesquisarPorId(Integer.parseInt(jTextField1.getText()));
        ...
        {
                 try {
                rs = dao.pesquisar(jTextField1.getText());
            } catch (SQLException ex) {
                Logger.getLogger(PesquisaProduto.class.getName()).log(Level.SEVERE, null, ex);
            }
